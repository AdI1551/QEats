...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(
    ...
    log.info("getRestaurants called with {}", getRestaurantsRequest);
      ...
      //CHECKSTYLE:OFF
        //for checking
        // getRestaurantsRequest.setLatitude(28.4900591);
        // getRestaurantsRequest.setLongitude(77.3066401);
        if (getRestaurantsRequest.getLatitude() == null || getRestaurantsRequest.getLongitude() == null || getRestaurantsRequest.getLatitude() < -90 || getRestaurantsRequest.getLatitude() > 90
     ...
     if(getRestaurantsRequest.getSearchFor()!=null && !getRestaurantsRequest.getSearchFor().isEmpty())
     {
      ...
      .findAllRestaurantsCloseBy(getRestaurantsRequest, LocalTime.now()); 
          ...
          {
            allRestaurants=getRestaurantsResponse.getRestaurants();
